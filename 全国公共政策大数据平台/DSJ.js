        ...
        r2 = {
            ...
            6: [function(e, t, n) {
                function o(e) {
                    ...
                    e.writeDoubleLE = m ? y : W,
                    e.writeDoubleBE = m ? W : y,
                    e.readDoubleLE = m ? b : S,
                    e.readDoubleBE = m ? S : b) : (e.writeDoubleLE = v.bind(null, r, 0, 4),
            ...
            31: [function(e, t, n) {
                t.exports = W;
                var o = e(21)
                  , r = (((W.prototype = Object.create(o.prototype)).constructor = W).className = "Type",
                e(14))
                  , a = e(23)
                  , i = e(15)
                  , l = e(18)
                ...
                W.generateConstructor = function(e) {
                ...
                ,
                W.fromJSON = function(e, t) {
                    for (var n = new W(e,t.options), u = (n.extensions = t.extensions,
                    ...
                    if (t.nested)
                        ...
                        c = 0; c < u.length; ++c) {
                            var d = t.nested[u[c]];
                            n.add((d.id !== g ? i : d.fields !== g ? W : d.values !== g ? r : d.methods !== g ? s : o).fromJSON(u[c], d))
                        }
                ...
                ,
                W.prototype.isReservedId = function(e) {
                    return o.isReservedId(this.reserved, e)
                }
                ,
                W.prototype.isReservedName = function(e) {
                ...
                ,
                W.prototype.encodeDelimited = function(e, t) {
                ...
                ,
                W.prototype.decodeDelimited = function(e) {
                    return e instanceof c || (e = c.create(e)),
                    this.decode(e, e.uint32())
                }
                ,
                W.prototype.verify = function(e) {
                    return this.setup().verify(e)
                }
                ,
                W.prototype.fromObject = function(e) {
                    return this.setup().fromObject(e)
                }
                ,
                W.prototype.toObject = function(e, t) {
...
function get_data(data){
    return PolicyInfoByTypeIdParam$encode(data).finish().slice()
}
